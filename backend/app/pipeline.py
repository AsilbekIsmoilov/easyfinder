...
def mark_duplicates() -> int:
    ...
    Guruhlash kaliti: (davlat, ketish sanasi, narx, valyuta). Har guruhda
    faqat ENG YANGI post qoldiriladi, qolganlari `is_duplicate=True` bo'ladi.
    O'chirilmaydi — eng yangisi eskirsa yoki post o'chirilsa, keyingi yurish
    yana eng yangisini tanlaydi.

    Shahar ataylab kalitga kirmaydi: u har postda turlicha ajraladi
